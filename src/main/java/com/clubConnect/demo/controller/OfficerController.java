...
public class OfficerController {
    ...
    public ResponseEntity<Object> updateAnnouncement(
        ...
        try {
            User officer = getUserById(officerId);
            Announcement updated = officerService.updateAnnouncement(clubId, announcementId, body.get("content"), officer);
    ...
    public ResponseEntity<Object> updateClubPage(
        ...
        try {
            ...
            Club updated = officerService.updateClubPage(clubId, description, images, officer);
            return ResponseEntity.ok(updated);
        } catch (IllegalArgumentException e) {
            return ResponseEntity.status(HttpStatus.NOT_FOUND)
                    .body(Map.of("error", e.getMessage()));
