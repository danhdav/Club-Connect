...
public class Club {
    ...
    public void setOfficers(List<User> newOfficers) {
        if (newOfficers == null) return;
        // ensure the field is initialized
        if (this.officers == null) {
            this.officers = new ArrayList<>();
        }

        for (User o : newOfficers) {
            addOfficer(o);
        }
    }
    ...
    public void setImages(List<String> imagesT) {
         this.images.addAll(imagesT);
    }
